...
<script type="text/javascript">
  ...
  <form method="POST" action="" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <img id="uploadPreview" style="width: 150px; height: 150px;" src="../admin/page/member/img/<?php echo $tampil['gambar']; ?>"/><br>
...
if (isset($_POST['simpan'])) {
  ...
  unlink("../admin/page/member/img/" . $tampil['gambar']);
  move_uploaded_file($asal, "../admin/page/member/img/" . $nama);
